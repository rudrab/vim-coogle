...
execute  printf('hi  MatchParen    guibg=%s       guifg=%s          gui=bold             ctermfg=red           cterm=bold',             VgRed,VgLgrey)
...
execute  printf('hi  SignColumn    guibg=%s       guifg=%s',            VgBlueGrey900,VgRedA1)
...
execute  printf('hi  ModeMsg       guifg=%s       gui=bold',            VgWhite3)
...
execute  printf('hi  Conceal       guibg=NONE     guifg=%s',       VgBlue)
